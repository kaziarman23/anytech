...
const AnyBaaSSection = () => {
  return (
    <div
      className="w-full h-screen relative overflow-hidden"
      style={{
        backgroundImage:
          "linear-gradient(to right, #9747FF 0%, #1F80F0 50%, #014AB8 100%)",
      ...
      >
        ...
        <div className="w-4/5 h-full mx-auto flex items-center z-20">
          <div className="w-4/5 space-y-2 lg:space-y-5">
            ...
            <figure>
              <img
                src="https://cdn.sanity.io/images/6jywt20u/production/5f843977de011f723a6348d5787b9ce353973f95-235x43.svg?w=235&auto=format"
                alt="AnyBaaS hero section image"
              />
            </figure>
          </div>
        </div>
          ...
          >
            ...
            <g id="hero-background-desktop">
              ...
              <g
                id="background"
                style={{
                  transform: "translate3d(-1.23865%, 0.919355%, 0px)",
