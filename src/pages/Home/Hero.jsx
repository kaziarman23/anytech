  ...
  return (
    <div className="w-full h-screen relative">
      ...
      <div
        ...
        className="w-full h-11/12 relative overflow-hidden"
      ...
      >
        <div
          ...
          className="bg-blue-500 h-full w-3/5 relative"
        ></div>
        {/* SVG Part */}
        ...
        <div className="absolute top-0 left-0">
          <svg
            className="hidden lg:block absolute top-0 left-0 object-cover"
            width="1920"
            height="929"
          ...
          >
            <g id="hero-background-desktop">
              <g
                id="background"
                style={{
                  transform: `translate3d(-0.7px, 0.8px, 0px)`,
                  transition:
