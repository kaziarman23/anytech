...
const Footer = () => {
  return (
    <>
      <div className="w-full h-full flex justify-center items-center flex-col relative overflow-visible ">
        {/* Clipped Background */}
        <div
          className="w-full h-screen bg-[#025ec8] relative overflow-hidden flex justify-center items-end"
          style={{
            clipPath: "polygon(0 10%, 100% 64%, 100% 100%, 0% 100%)",
            WebkitClipPath: "polygon(0 10%, 100% 64%, 100% 100%, 0% 100%)",
          }}
        >
          {/* context part */}
          <div className="w-4/5 h-1/2 space-y-10 text-white">
          ...
          {/* SVG'S */}
          <div className="absolute top-0 left-0 border-2">
            <svg
              width="1920"
              height="693"
