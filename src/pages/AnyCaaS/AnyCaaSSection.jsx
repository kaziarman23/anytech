const AnyCaaSSection = () => {
  return (
    <div
      className="w-full h-screen relative"
      style={{
        backgroundImage: "linear-gradient(to right, #1CC800 46%, #1F80F0 100%)",
      ...
      >
        ...
        <div className="w-4/5 h-full mx-auto flex items-center z-20">
          <div className="w-4/5  space-y-5">
            ...
            <figure>
              <img
                src="https://cdn.sanity.io/images/6jywt20u/production/a0d52dbf3dc616daa67af788c08edd1305f7dfe9-235x43.svg?w=235&auto=format"
                alt="AnyCaaS hero section image"
              />
            </figure>
          </div>
        </div>
        ...
        >
          ...
          <g id="hero-background-desktop">
            ...
            <g
              id="background"
              style={{
                transform: "translate3d(-1.34078%, 0.943548%, 0px)",
          ...
          <defs>
            ...
            >
              <stop stopColor="#1CC800"></stop>
              <stop offset="1" stopColor="#1CC800" stopOpacity="0"></stop>
            </linearGradient>
            <linearGradient
